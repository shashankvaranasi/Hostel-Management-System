...
<?php 
		 $ret= mysqli_query($bd,"SELECT * FROM registration where id = '".$_GET['id']."'");
			...
			<tr>
			  <td colspan="2" style="font-size: 25px; color:darkslateblue; text-decoration:underline; font-weight:bolder"><span> information of </span><?php echo ucfirst($row['firstName']);?> <?php echo ucfirst($row['lastName']);?> </td>
  </tr>
			<tr>
